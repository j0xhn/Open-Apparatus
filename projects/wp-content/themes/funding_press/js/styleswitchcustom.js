    ...
    jQuery(function($){
        $('.slide-out-div').tabSlideOut({
            ...
            pathToTabImage: 'http://skywarriorthemes.com/fundingpress/wp-content/themes/funding_press/img/picker.jpg', //path to the image for the tab //Optionally can be set using css

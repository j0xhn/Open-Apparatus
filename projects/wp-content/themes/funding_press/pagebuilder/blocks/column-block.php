...
class Column_Block extends Block {
	...
	function form($instance) {
		...
		__('Drag block items into this column box', 'funding'),
		'</p>';
	...
	function after_form($instance) {
		...
		$block_saving_id = 'blocks[block_'.$number.']';
			...
			echo '<div class="block-control-actions cf"><a href="#" class="delete">'._e("Delete", "funding").'</a></div>';
